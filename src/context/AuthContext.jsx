...
export const AuthProvider = ({ children }) => {
    ...
    const verifyOtp = async (userId, otp, trustDevice) => {
        const res = await api.post('/auth/verify-otp', { userId, otp, trustDevice });
    ...
    const verifyTotp = async (userId, token, trustDevice) => {
        const res = await api.post('/auth/verify-totp', { userId, token, trustDevice });
    ...
    return (
        <AuthContext.Provider value={{ user, login, verifyOtp, resendOtp, verifyTotp, register, logout, loading }}>
            {children}
