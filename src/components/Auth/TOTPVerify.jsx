            ...
            {mfaType === 'totp_setup' && (
                <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                    <p style={{ marginBottom: '1rem', color: '#2d3748' }}>
                        <strong>Setup Required:</strong> Scan this QR Code with your Authenticator App (Google/Microsoft Auth).
                    </p>
                    <img src={qrCode} alt="TOTP QR Code" style={{ border: '1px solid #ddd', borderRadius: '8px', padding: '10px' }} />
                </div>
            )}
